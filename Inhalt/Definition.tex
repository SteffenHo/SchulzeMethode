...
In den Beispielen werden diese Duelle in einem Graphen dargestellt. Eine vollständigen Schreibweise, wie in Abbildung \ref{fig:verbindung1} skizziert, wird in Beispiel 3 in Abschnitt \ref{sec:beispiel3} benötigt.
...
Die grundsätzliche Idee der \schulze ist es, ein condorectes Verfahren, wo ein Duell von Kandidat $a$ gegen Kandidat $b$ eingesetzt wird. Hierbei wird das Verfahren jedoch erweitert, indem die Werte für die Duelle erst berechnet werden.
